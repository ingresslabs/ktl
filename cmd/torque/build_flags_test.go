// File: cmd/torque/build_flags_test.go
...
func TestBuildCommandFlagPropagation(t *testing.T) {
	...
	t.Setenv("TORQUE_DOCKER_CONFIG", "")
	t.Setenv("DOCKER_CONFIG", "")
	t.Setenv("MY_SECRET", "super-secret")
	t.Setenv("TORQUE_AUTHFILE", "")
	t.Setenv("TORQUE_REGISTRY_AUTH_FILE", "")
...
func disableSandboxForTests(t *testing.T) {
	...
	t.Setenv("TORQUE_NSJAIL_DISABLE", "1")
}
